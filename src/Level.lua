...
function Level:init()
    ...
    -- define collision callbacks for the world; the World object expects four,
    ...
    function beginContact(a, b, coll)
       ...
       -- if collision is between player and obstacle...
       if types['Obstacle'] and types['Player'] then 
            ...
            -- destroy the obstacle if the player's combined X/Y velocity is high enough
    ...
    -- the remaining 3 functions are not implemented for this basic code
